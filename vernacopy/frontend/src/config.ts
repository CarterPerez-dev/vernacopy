...
export const API_ENDPOINTS = {
  ...
  CLARITY: {
    LOOKUP: `/${API_VERSION}/clarity/lookup`,
    SCAN: `/${API_VERSION}/clarity/scan`,
    COMPARE: `/${API_VERSION}/clarity/compare`,
    HISTORY: {
      LIST: `/${API_VERSION}/clarity/history`,
      BY_ID: (id: string) => `/${API_VERSION}/clarity/history/${id}`,
      DELETE: (id: string) => `/${API_VERSION}/clarity/history/${id}`,
    },
  },
} as const
...
export const QUERY_KEYS = {
  ...
  CLARITY: {
    ALL: ['clarity'] as const,
    HISTORY: {
      ALL: ['clarity', 'history'] as const,
      LIST: (params: { page: number; size: number }) =>
        ['clarity', 'history', 'list', params] as const,
      DETAIL: (id: string) => ['clarity', 'history', 'detail', id] as const,
    },
  },
} as const
...
export const ROUTES = {
  ...
  TOOLS: {
    WORD_CLARITY: '/tools/word-clarity',
    WORD_CLARITY_HISTORY: '/tools/word-clarity/history',
  },
} as const
