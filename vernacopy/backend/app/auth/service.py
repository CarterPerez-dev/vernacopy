...
class AuthService:
    ...
    async def login_mobile(
        ...
        """
        Mobile login - returns both tokens and user
        """
        access_token, refresh_token, user = await self.authenticate(
            email,
            password,
    ...
    async def refresh_tokens_mobile(
        self,
        refresh_token: str,
        device_id: str | None = None,
        device_name: str | None = None,
        ...
        """
        Mobile refresh - returns both tokens in response body
        """
        token_response, new_refresh_token = await self.refresh_tokens(
            refresh_token,
            device_id,
            device_name,
            ip_address,
